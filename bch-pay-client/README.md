...
| **BCH Trading Advisor** | Bot de Telegram con análisis técnico (RSI, MACD, Bollinger) | `TELEGRAM_BOT_TOKEN=<token> python examples/agent_telegram_trading.py` |
...
- [BCH Trading Advisor](docs/trading.md) - Análisis técnico + bot Telegram
